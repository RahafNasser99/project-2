...
abstract class CommentsRepository {
  ...
  Future<Either<Failure, Unit>> editComments(Comment comment, bool postOrAdvice, int postId);
  Future<Either<Failure, Unit>> deleteComments(int commentId, bool postOrAdvice, int postId);
}
